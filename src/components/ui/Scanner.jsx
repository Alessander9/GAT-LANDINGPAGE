  ...
  useEffect(() => {
    ...
    try {
      ...
      try {
        ...
        console.warn('WebGL initialization failed in Scanner:', err);
        setWebglFailed(true);
        return;
      }
    }
      ...
      {webglFailed && (
        <div
          style={{
            ...
            inset: 0,
            background:
              'radial-gradient(ellipse at 50% 40%, rgba(9, 168, 181, 0.22) 0%, rgba(18, 50, 74, 0.45) 45%, rgba(7, 21, 33, 0.95) 100%)',
            pointerEvents: 'none',
          }}
        />
      )}
