...
const BENTO_SERVICES = [
  // 1. Top Left (Col span 7) - Páginas Web Corporativas (Live Video)
  {
    ...
    icon: Globe,
    image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=480&q=60&fm=webp",
  ...
  // 3. Bottom Left (Col span 4) - Aplicativos Web & SaaS (Live Video)
  {
    ...
    icon: Layers,
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=420&q=60&fm=webp",
  ...
  // 4. Bottom Center (Col span 4) - Apps Android & Móviles (Live Video)
  {
    ...
    icon: Smartphone,
    image: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?auto=format&fit=crop&w=420&q=60&fm=webp",
  ...
  // 5. Bottom Right (Col span 4) - Ciberseguridad Zero Trust (Live Video)
  {
    ...
    icon: Shield,
    image: "https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=420&q=60&fm=webp",
